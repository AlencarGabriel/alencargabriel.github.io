...
Segue a documentação da rotina contendo todos os detalhes e informações de uso e parâmetros: [https://github.com/AlencarGabriel/advpl-MsgTimer#documentação](https://github.com/AlencarGabriel/advpl-MsgTimer#documentação)
